...
# ACDS 19.1 670 win32 2020.11.22.14:31:18
# ----------------------------------------
...
alias com {
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_avalon_st_adapter_004_error_adapter_0.sv" -l altera_common_sv_packages -work error_adapter_0                             
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_avalon_st_adapter_004.v"                                               -work avalon_st_adapter_004                       
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L altera_common_sv_packages -L error_adapter_0 -L avalon_st_adapter_004 -L avalon_st_adapter -L sdram_controller_s1_rsp_width_adapter -L rsp_mux_001 -L rsp_mux -L rsp_demux_003 -L rsp_demux -L cmd_mux_003 -L cmd_mux -L cmd_demux_001 -L cmd_demux -L sdram_controller_s1_burst_adapter -L router_006 -L router_005 -L router_002 -L router_001 -L router -L jtag_uart_0_avalon_jtag_slave_agent_rsp_fifo -L jtag_uart_0_avalon_jtag_slave_agent -L nios2_gen2_0_data_master_agent -L jtag_uart_0_avalon_jtag_slave_translator -L nios2_gen2_0_data_master_translator -L cpu -L rst_controller -L irq_mapper -L mm_interconnect_0 -L sdram_controller -L pll_0 -L onchip_memory2_0 -L nios2_gen2_0 -L jtag_uart_0 -L LEDs -L sdram_controller_my_partner -L dnn_accel_system_inst_reset_bfm -L dnn_accel_system_inst_pll_locked_bfm -L dnn_accel_system_inst_hex_bfm -L dnn_accel_system_inst_clk_bfm -L dnn_accel_system_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
