...
mkdir -p ./libraries/sram_instruction_mem/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  ...
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_sram_instruction_mem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_avalon_st_adapter_003_error_adapter_0.sv" -work error_adapter_0                              -cdslib ./cds_libs/error_adapter_0.cds.lib                             
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_avalon_st_adapter_003.v"                  -work avalon_st_adapter_003                        -cdslib ./cds_libs/avalon_st_adapter_003.cds.lib                       
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_sram_instruction_mem.v"                                     -work sram_instruction_mem                         -cdslib ./cds_libs/sram_instruction_mem.cds.lib                        
